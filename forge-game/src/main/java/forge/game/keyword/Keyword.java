...
public enum Keyword {
    ...
    RERUN("Rerun", SimpleKeyword.class, true, "Then if you cast this from your hand, exile it as it resolves. Whenever a creature you control dies, you may cast this card from exile without paying its mana cost."),
